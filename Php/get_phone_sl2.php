...
$query="SELECT SL_SERVICE.NAME,SL_SERVICE.CATEGORY,SL_SERVICE.DESCRIPTION,SL_SERVICE.ID,SL_SERVICE.ACTIVATION,HAS_SL.DEVICE_ID FROM SL_SERVICE,HAS_SL WHERE SL_SERVICE.ID=HAS_SL.SL_ID";
