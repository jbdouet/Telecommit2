$("document").ready(function(){
 ...
 $.ajax({
        ...
        method: "POST",
            ...
            crossDomain: true,
            url: "http://telecommit.altervista.org/php/get_promoted_devices.php", //Relative or absolute path to file.php file
...
function insert_into_row(promoteddevices, index) {
    ...
    row+="</tr>";
    row+="<tr><td align='center'><a href='http://telecommit.altervista.org/get_tablet.html?tablet=" + promoteddevices[index].id + "' class='animation animated-item-3' role='button'>VIEW			          </a></td></tr>";
    row+="</table></div>";
