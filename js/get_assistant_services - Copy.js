$("document").ready(function(){
 ...
 $.ajax({
        ...
        method: "POST",
            ...
            crossDomain: true,
            url: "http://telecommit.altervista.org/php/get_assistant_services.php", //Relative or absolute path to file.php file
...
function insert_into_row(linemanagement, index) {
    ...
    row+="</tr>";
    row+="<tr><td align='center'><a href='get_tablet.html?tablet=" +linemanagement[index].id+ "' class='animation animated-item-3' role='button'>VIEW</a></td></tr>";
    row+="</table></div>";
