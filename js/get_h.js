...
function view_format(tablet) {
    ...
    row+="<tr><td align='center'><a href='get_health_devices.html?health=" +tablet.id+ "' class='animation animated-item-3' role='button'>COMPATIBLE DEVICES</a></td></tr>";
 ...
 // row+="<tr><td align='center'><input type='submit' value='FAQ' id='" +tablet.id+ "' class='scopri' role='button'></input></td></tr>";
    ...
    row+="<tr><td align='center'><a href='get_health_faq.html?health=" +tablet.id+ "' class='animation animated-item-3' role='button'>FAQ</a></td></tr>";
...
$("document").ready(function(){
 $.ajax({
        method: "POST",
            ...
            crossDomain: true,
            url: "php/get_health.php", //Relative or absolute path to file.php file
            
            success: function(response) {
				var tablet=JSON.parse(JSON.stringify(response));
				var row = "";
				var tablet_id=get_url_param("health");
